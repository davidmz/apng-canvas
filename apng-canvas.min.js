...
function(a){return b.btoa?"data:"+a+";base64,"+btoa(this.parts.join("")):"data:"+a+","+escape(this.parts.join(""))};typeof XMLHttpRequest.prototype.responseBody!="undefined"&&typeof document.addEventListener!="undefined"&&document.addEventListener("DOMContentLoaded",function(){var a=document.createElement("script");a.setAttribute("type","text/vbscript");a.text="Function APNGIEBinaryToBinStr(Binary)\r\n   APNGIEBinaryToBinStr = CStr(Binary)\r\nEnd Function\r\n";document.body.appendChild(a)});var t=
function(k){var e=new Deferred;d.log("Starting load url: "+k,a.LOG_INFO);var c=new XMLHttpRequest,j=b.BlobBuilder||b.WebKitBlobBuilder,o=typeof c.responseBody!="undefined",g=typeof c.responseType!="undefined"&&typeof j!="undefined",h=typeof c.overrideMimeType!="undefined"&&!g;d.log("useResponseBody: "+(o?1:0),a.LOG_DEBUG2);d.log("useResponseType: "+(g?1:0),a.LOG_DEBUG2);d.log("useXUserDefined: "+(h?1:0),a.LOG_DEBUG2);c.open("GET",k,!0);g?c.responseType="arraybuffer":h&&c.overrideMimeType("text/plain; charset=x-user-defined");
c.onreadystatechange=function(){if(this.readyState==4&&this.status==200)if(d.log("Done load url: "+k,a.LOG_INFO),g){var b=new j;b.append(this.response);var i=new FileReader;i.onload=function(){e.resolve(this.result)};i.readAsBinaryString(b.getBlob())}else{b="";if(o)for(var i=APNGIEBinaryToBinStr(this.responseBody),h=0,m=i.length;h<m;h++){var l=i.charCodeAt(h);b+=String.fromCharCode(l&255,l>>8&255)}else{i=this.responseText;h=0;for(m=i.length;h<m;++h)b+=String.fromCharCode(i.charCodeAt(h)&255)}e.resolve(b)}else this.readyState==
4&&(d.log("Fail load url: "+k,a.LOG_ERROR),e.reject(c))};c.send();return e.promise()},y=function(b){var e=new Deferred;d.log("Start data parsing: "+escape(b.substr(0,8))+"...",a.LOG_INFO);if(b.substr(0,8)!=n)return d.log("Invalid PNG file signature: "+escape(b.substr(0,8))+"...",a.LOG_ERROR),e.reject("Invalid PNG file signature"),e.promise();var c={width:0,height:0,isAnimated:!1,numPlays:0,frames:[]},g,o="",j="",h=8,f=null;do{var i=l(b.substr(h,4)),p=b.substr(h+4,4),m;d.log("Found chunk: "+p,a.LOG_DEBUG2);
switch(p){case "IHDR":g=m=b.substr(h+8,i);c.width=l(m.substr(0,4));c.height=l(m.substr(4,4));d.log("Image has size "+c.width+"x"+c.height,a.LOG_DEBUG);break;case "acTL":c.isAnimated=!0;c.numPlays=l(b.substr(h+8+4,4));d.log("Image is animated",a.LOG_DEBUG);break;case "fcTL":f&&c.frames.push(f);m=b.substr(h+8,i);f={};f.width=l(m.substr(4,4));f.height=l(m.substr(8,4));f.left=l(m.substr(12,4));f.top=l(m.substr(16,4));var t=q(m.substr(20,2)),u=q(m.substr(22,2));u==0&&(u=100);f.delay=1E3*t/u;f.disposeOp=
m.charCodeAt(24);f.blendOp=m.charCodeAt(25);f.dataParts=[];break;case "fdAT":f&&f.dataParts.push(b.substr(h+8+4,i-4));break;case "IDAT":f&&f.dataParts.push(b.substr(h+8,i));break;case "IEND":j=b.substr(h,i+12);break;default:o+=b.substr(h,i+12)}h+=12+i}while(p!="IEND"&&h<b.length);f&&c.frames.push(f);d.log("Found "+c.frames.length+" frames",a.LOG_DEBUG);c.isAnimated||e.resolve(c);d.log("Start making frames",a.LOG_INFO);for(var v=0,b=0;b<c.frames.length;b++){h=new Image;f=c.frames[b];f.img=h;h.onload=
function(){v++;d.log("Image created ("+v+")",a.LOG_DEBUG2);v==c.frames.length&&e.resolve(c)};h.onerror=function(){d.log("Image creation error",a.LOG_ERROR);e.reject("Image creation error")};i=new s;i.append(n);g=r(f.width)+r(f.height)+g.substr(8);i.append(w("IHDR",g));i.append(o);for(p=0;p<f.dataParts.length;p++)i.append(w("IDAT",f.dataParts[p]));i.append(j);i=i.getUrl("image/png");d.log("Image url: "+i.substr(0,64)+"...",a.LOG_DEBUG2);h.src=i;delete f.dataParts}return e.promise()},z=function(a,b){var c=
b.getContext("2d"),e=0,d=null,g=function(){var b=e++%a.frames.length,f=a.frames[b];if(b==0&&(c.clearRect(0,0,a.width,a.height),d=null,f.disposeOp==2))f.disposeOp=1;d&&d.disposeOp==1?c.clearRect(d.left,d.top,d.width,d.height):d&&d.disposeOp==2&&c.putImageData(d.iData,d.left,d.top);d=f;d.iData=null;if(d.disposeOp==2)d.iData=c.getImageData(f.left,f.top,f.width,f.height);f.blendOp==0&&c.clearRect(f.left,f.top,f.width,f.height);c.drawImage(f.img,f.left,f.top);(a.numPlays==0||e/a.frames.length<a.numPlays)&&
setTimeout(g,f.delay)};g()}})();
